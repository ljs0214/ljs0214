...
class autoTrade :
    ...
    def get_today_data(self) :
        ...
        # 노이즈 20일 평균
        daily_data['noise_ma20'] = daily_data['noise'].rolling(window=1).mean().shift(1)
        ...
        # 5일 이동평균선
        daily_data['ma5'] = daily_data['close'].rolling(window=2, min_periods=1).mean().shift(1)
        # 상승장 여부
...
acc_key = "tLx3BrnozBqXQDsw8BfdxQRZnrFCLdx3HFOEqn0L"    # Access Key
sec_key = "z9GRAU7LpcZj5xHFqmEuLf4fTyc9gopSdLQp6DeF"    # Secret Key
app_token = "xoxb-3263374258582-3270040219171-VZMA2IjgAvpvXuXmNwJXg66W"  # App Token
